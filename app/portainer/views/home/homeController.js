...
angular
  ...
  .controller('HomeController', function ($q, $scope, $state, TagService, Authentication, EndpointService, GroupService, Notifications, StateManager, ModalService, MotdService) {
    $scope.state = {
